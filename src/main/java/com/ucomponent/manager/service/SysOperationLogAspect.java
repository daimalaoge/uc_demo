...
@Aspect
@Component
public class SysOperationLogAspect implements ICommons {
  //定义切点 @Pointcut
  private HttpServletRequest request = null;
  @Autowired
  private MangSysOperationLogRepository ucmOperationLogRepository;
...
//	  MangUserAccount user = super.getUser();
  ...
  public  void after(JoinPoint joinPoint) {  
    ...
    MangSysOperationLog log = new MangSysOperationLog();
