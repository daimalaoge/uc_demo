...
INSERT INTO `ucm_sys_codeset`(`id`, `name`, `code_key`, `level`, `descp`, `upper_code`, `attr_value1`, `attr_value2`, `attr_value3`, `attr_value4`, `attr_value5`, `attr_value6`, `attr_value7`, `attr_value8`, `attr_value9`, `attr_value10`, `seq`, `codeset_gstatus`, `create_datetime`, `update_datetime`, `create_user_id`, `update_user_id`) VALUES (17, '内部页面', 'MENU_TYPE_IN', '3', '', 'MENU_TYPE', '', '', '', '', '', '', '', '', '', '', 0, 'G_STATUS_USE', NULL, NULL, 0, 0);
